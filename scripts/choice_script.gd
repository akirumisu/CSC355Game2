...
var choice2Text = "During a meeting at the company's headquarters in St. Louis, a manager brings up the topic of this month's electricity bill. They recommend you switch the office to LED lights to save energy costs."
...
var summary2Option1 = "The savings from using LED lights are incredible. The cost of lighting is 400% cheaper for the headquarters building. Lighting is only a tiny part of the company's expenses, so the amount you save is equally tiny. Thankfully, having a smaller electricity bill helps out the environment."
...
var summary2Option3 = "The savings from using LED lights are incredible. The cost of lighting is 400% cheaper for all buildings now. Lighting is only a tiny part of the company's expenses, so the amount you save is equally tiny. Thankfully, having a smaller electricity bill helps out the environment."
...
var summary3Option1 = "You decide to pump water from a lake in the US. Most of your customers are from the US and approve this action to provide jobs. Some oppose it, but as long as you limit water pumping, the population should be okay with it."
...
var choice4Option2 = ["Compressed natural gas trucks", 1.2, -20, 0.95, ""]
var choice4Option3 = ["Traditional semi-trucks", 1.3, -30.0, 0.9, ""]
...
var choice5Option1 = ["Increase production and marketing by 50%", 1.2, -12.5, 0.8, ""]
var choice5Option2 = ["Increase production and marketing by 100%", 1.3, -25.0, 0.6, ""]
var choice5Option3 = ["Leave the bottled water industry", 0.8, 1.0, 1.0, ""]
var summary5Option1 = "You increase production and marketing by 50%. This move resulted in the company staying competitive in the bottled water market. The environment is not happy about it, but your stockholders enjoy it."
var summary5Option2 = "You double down and increase production and marketing by 100%. As a result, your market share in bottled water increased even after competitor’s marketing. Unfortunately, you get into a little bit of legal trouble as the population notices your antics. Perhaps you increased production too much?"
...
var summary6Option2 = "You keep using the energy grid. Everyone else is at the mercy of the energy grid anyway, so why change it? Hopefully coal doesn't power too much of the energy you use."
...
var summary8Option2 = "You host online-only company meetings. Fewer people have to fly to these meetings and instead join online wherever they are located. It turns out you are helping the environment by having others stay home instead of flying. Some people are disappointed with this choice, but your company also saves money by not paying for hotels and a physical location."
...
var summary9Option1 = "Reducing package saved your company a small amount every day, it adds up over time. By recycling, you are also helping out the environment. This only costs a small amount of money to implement."
...
var summary9Option3 = "You review the route logistics for trucks at the mega factory. It costs more to have an expert review this, but the results are shocking. Taking an alternate route during the week-days can result in a 10% shorter drive, saving fuel costs as well as helping the environment."

var choice10Text = "The food processing sector has gone down. Stockholders are worried about the company's future. Perhaps you should try dipping your toes in another sector?"
...
var summary10Option1 = "You decide to try out the oil transportation sector. This sector has been declining over the years, but the potential profits are still high. This move is seen as controversial, and some people have started boycotting your company for getting involved in oil. The actual profit generated is not nearly as much as you had hoped for because of the boycotts. You decide to exit the oil sector and just stick to food processing."
...
var summary10Option3 = "You start a small fast food chain with a few locations. Many people know your company's brand and line up at the door to try signature menu items. The environmental impact of fast food chains is more than you had considered. Hopefully, the population won't notice, or you will have to make changes."
...
var choice11Option1 = ["Reduce the number of API calls", 1.0, 0.5, 0.95, ""]
...
var summary11Option2 = "You switch away from AWS to another company. It turns out, that while their data centers are powered by renewables, they are not net zero. You were able to land a favorable contract by working directly with another cloud service, they were willing to charge you less than AWS if you continue working with them for years to come."
var summary11Option3 = "You decide to hire some software engineers to clean up old code and get rid of old services. Some of the old services were sending automated API calls, or using multiple API calls when unnecessary. The salaries of the new employees offset some of the profits, but now you won't pay as much for cloud computing."
...
var summary12Option1 = "You simply increase production. This generates more profit at the cost of hurting the environment. There are inefficiencies at the mega factory that you should have tried to fix first."
var summary12Option2 = "You capture and reuse heat as energy. Overall, the mega factory produces a lot of heat, so now you won't have to pay as much electricity to keep the mega factory running. Depending on where you get your electricity from determines how much this helps the environment."
var summary12Option3 = "You recycle unused office supplies and clutter throughout the mega factory’s offices. It's not much, but it helps clean up the place and the materials will be recycled into new goods in the future. Employees are more productive without the useless clutter."
...
var choice13Option3 = ["Build digital billboards", 1.1, -4.0, 0.8, ""]
var summary13Option1 = "You advertise online. It works better than you expected and people flock to the stores to buy your product. Surprisingly, there is a slight harm to the environment from the energy used to show your ad campaign."
var summary13Option2 = "You contract some billboards to be built. It works and people flock to the stores to buy your product. There is also a slight harm to the environment for cutting down trees to install these billboards along the highway."
var summary13Option3 = "You contract some digital billboards to be built. It works and people flock to the stores to buy your product. You didn't realize this, but the energy costs for digital billboards are extreme. The increased energy hurts the environment more than traditional billboards. Furthermore, cutting down trees to install billboards along the highway hurts the environment."

var choice14Text = "The board of directors and senior managers at the company have worked hard over the years and need a vacation. What kind of vacation do you think they deserve?"
...
var choice14Option3 = ["No vacation, just compensate them instead", 1.0, 0.0, 0.8, ""]
var summary14Option1 = "You give the board of directors and senior managers a private jet vacation to the Bahamas. Everyone is enjoying themselves in the Bahamas, but the private jets are expensive and contribute to pollution. Perhaps the company should look into commercial flights or a ship for transportation instead."
var summary14Option2 = "You give the board of directors and senior managers a private jet vacation to Dubai. This is also a way for your company to network and reach out to others for joint business deals. The private jets are expensive and contribute to pollution. Perhaps the company should look into commercial flights or a ship for transportation instead."
var summary14Option3 = "You keep things simple and give the board of directors and senior managers a hefty fund for their continued service over the years. The board of directors and senior managers probably prefer to spend their money however they see fit anyway. You end up spending less money by not scheduling a vacation."
...
var choice15Option1 = ["Lower emissions", 1.0, 0.5, 0.95, ""]
var choice15Option2 = ["Do nothing", 1.0, -5.0, 0.8, ""]
var choice15Option3 = ["Lobby against emissions regulations", 1.1, -25.0, 0.95, ""]
var summary15Option1 = "You lower emissions by buying energy-efficient products here and there. The company's emissions aren’t much lowered, but on a national scale, it adds up to all the other companies lowering emissions. Your company will not have to pay a fine."
...
var summary15Option3 = "You lobby against emissions regulations. It was not successful. The deal went through Congress, and your company was forced to pay a fine. Thankfully, the profit from production mostly offset the fines."
